...
2. Load the necessary asset files.
3. Create a humanoid template with some shapes.
4. Create an entity with a CharacterShapeConfig component.
...
Characters are entities with a CharacterShapeConfig.
