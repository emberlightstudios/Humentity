...
pub mod prelude {
    ...
    pub use crate::physics::{ColliderBone, RagdollCompliance, RagdollDamping, RagdollDensity, RagdollMobility, RagdollSleep, COLLIDERS};
    #[cfg(feature = "avian")]
        ...
        #[cfg(feature = "avian")]
        {
            ...
            app.register_type::<RagdollDensity>()
                ...
                (
                    ...
                    physics::avian::put_ragdoll_to_sleep,
                ),
            )
            .add_systems(
                FixedUpdate,
